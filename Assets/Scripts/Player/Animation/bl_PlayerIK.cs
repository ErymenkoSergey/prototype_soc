...
public class bl_PlayerIK : bl_MonoBehaviour
{
    ...
    public bl_BodyIKHandler CustomArmsIKHandler { get; set; } = null;
    ...
    private float rightArmIKWeight = 0;
    ...
    void ArmsIK()
    {
        ...
        rightArmIKWeight = Mathf.Lerp(rightArmIKWeight, rpw, deltaTime * 7);
#if UNITY_EDITOR
        if (!Application.isPlaying)
        {
            if (editor_previewMode == 1) rightArmIKWeight = editor_weight;
        }
#endif
        ...
        animator.SetIKPositionWeight(AvatarIKGoal.RightHand, rightArmIKWeight);
