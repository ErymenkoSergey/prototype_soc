...
public class bl_AIShooterAgent : bl_AIShooter
{
    ...
    private void DoAliveRespawn()
    {
        ...
        isGameStarted = false;
        Target = null;
        this.InvokeAfter(2, () => { isGameStarted = TimeManager.TimeState == RoomTimeState.Started; });
    ...
    void OnMatchStateChange(MatchState state)
    {
        ...
        else isGameStarted = TimeManager.TimeState == RoomTimeState.Started;
    }
    ...
    void OnMatchStart()
    {
        isGameStarted = bl_GameManager.Instance.GameMatchState != MatchState.Waiting && TimeManager.TimeState == RoomTimeState.Started;
    }
